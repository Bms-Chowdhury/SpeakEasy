...
export default function Home() {
  const { initialize, getPublishedPosts, getTrendingPosts, initialized } =
    usePostStore();

  // Add state for posts
  const [publishedPosts, setPublishedPosts] = useState<Post[]>([]);
  // ✅ FIX: unused variable _trending (underscore prefix)
  const [_trending, setTrending] = useState<Post[]>([]);
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                Grammar tips, vocabulary & speaking strategies
              </p>
            </div>
            <Link
              to="/blog"
          ...
          <div className="mt-10 text-center">
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-semibold text-sm hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors"
            >
              ...
              const cardStyles = [
                {
                  ...
                  hoverBorder:
                    "hover:border-rose-300 dark:hover:border-rose-800/50",
                ...
                },
                {
                  ...
                  hoverBorder:
                    "hover:border-blue-300 dark:hover:border-blue-800/50",
                ...
                },
                {
                  ...
                  hoverBorder:
                    "hover:border-amber-300 dark:hover:border-amber-800/50",
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className={`group block p-5 rounded-2xl ${style.bg} border ${style.border} ${style.hoverBorder} hover:shadow-lg hover:${style.shadow} transition-all duration-300`}
                  >
                    <div className="text-3xl mb-3">{cat.icon}</div>
                    <h3
                      className={`font-semibold text-slate-900 dark:text-white mb-1 ${style.hoverText} transition-colors`}
                    >
                      {cat.name}
                    </h3>
            ...
            {[
              {
                ...
                desc: "Practice with dialogue scripts based on real-life situations.",
                bg: "bg-gradient-to-br from-indigo-50/80 to-blue-50/80 dark:from-indigo-950/30 dark:to-blue-950/20",
              },
              {
                icon: <Users className="text-purple-600" size={24} />,
                title: "All Levels Welcome",
                desc: "Whether you're a beginner or advanced, find content tailored to your goals.",
                bg: "bg-gradient-to-br from-purple-50/80 to-pink-50/80 dark:from-purple-950/30 dark:to-pink-950/20",
              },
              {
                icon: <Sparkles className="text-pink-600" size={24} />,
                title: "Learn by Doing",
                desc: "Read out loud, listen with AI audio, and practice actively.",
                bg: "bg-gradient-to-br from-amber-50/80 to-orange-50/80 dark:from-amber-950/30 dark:to-orange-950/20",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                className={`p-6 rounded-2xl ${item.bg} border border-slate-200/80 dark:border-slate-800`}
              >
